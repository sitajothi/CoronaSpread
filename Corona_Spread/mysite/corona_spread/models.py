...
class GlobalCases(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'global_cases'


class HospitalData(models.Model):
    state = models.CharField(max_length=50)
    hosp_num = models.IntegerField()
...
class UsCasesDay(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'us_cases_day'

class predict_death(models.Model):
    _state = models.CharField(max_length=50)
    death_num = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'predict_death'
